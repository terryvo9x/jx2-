...
tAward = {
	randMulti = 1,
	subclauses = {
		{ {"Cæ Linh Th¹ch", {2,1,30368,5}, nil,nil,{1, 100} }, 5000},
		{ {"Cæ Linh Ngäc", {2,1,30369,5}, nil,nil,{1, 100} }, 5000},
		{ {"Cæ Linh Th¹ch", {2,1,30368,100}, nil,nil,{1, 100} }, 500},
		{ {"Cæ Linh Ngäc", {2,1,30369,100}, nil,nil,{1, 100} }, 500},
		{ {"Hu©n ch­¬ng anh hïng", {2,1,30499,5}, nil,nil, {1, 100}}, 5000},
		{ {"Hu©n ch­¬ng anh hïng", {2,1,30499,100}, nil,nil, {1, 100}}, 500},
		{ {"M¶nh Thiªn M«n", {2,1,30410,10}, nil,nil,{1, 100} }, 2000},
		{ {"M¶nh Thiªn Cang", {2,1,30390,50}, nil,nil,{1, 100} }, 2000},
				{{"Thiªn Cang LÖnh", {2,95,204,1}, nil,nil, {1, 100}}, 400},
		{{"Thiªn M«n Kim LÖnh", {2,1,30370,1}, nil,nil, {1, 100}}, 400},
        {{"Tr­êng Hµi Du HiÖp"    ,{0,154,26,1},msg},1000},
        {{"ChiÕn Hµi ThiÕt HuyÕt"    ,{0,154,27,1},msg},1000},
        {{"§¹o Hµi V©n Du"    ,{0,154,28,1},msg},1000},
