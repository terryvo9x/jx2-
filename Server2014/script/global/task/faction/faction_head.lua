...
TB_ROUTE_IN_INFO = {
	...
	[25] = {
		...
		skill = {{3,"§ao tÊn c«ng b×nh th­êng"},{1053,"Th¸nh Háa Kim L­ C«ng"}},
...
function learn_skill(route_seq)
	if GetPlayerRoute() ~= route_seq then	--Á÷ÅÉ¼ì²â
		Talk(1,"","<color=green>"..TB_ROUTE_IN_INFO[route_seq].npc_name.."<color>: Ng­¬i kh«ng ph¶i ®Ö tö cña ta, kh«ng thÓ häc vâ c«ng.")
	else
