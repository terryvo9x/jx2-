...
--    end
    ...
    if DelItemByIndex(nItemIdx, 1) == 1 then
    	----------------------- Chuçi nhiÖm v?ChuyÓn Sinh §¬n, l­u s?th?6 v?7 ®Çu bªn ph¶i
...
--		ModifyExp(nExpVM)
--		if nExpVM > 0 then
--			Msg2Player("B¹n nhËn thªm ".. nExpVM.." ®iÓm kinh nghiÖm t?vËn may!")
--		else
--			Msg2Player("B¹n b?tæn thÊt ".. nExpVM.." ®iÓm kinh nghiÖm do kh«ng may m¾n. H·y ®i gi¶i vËn xui ?ThÇy Bãi Siªu H¹ng!")
--		end
			----------		
	...
	--Say("H«m nay, ®©y l?lÇn th?<color=yellow>"..GetTask(VET_201012_04_PLANT_4_SOUL_TREE_COUNT).."<color> b¹n trång c©y T?Linh,  h«m nay b¹n vÉn c?th?trång <color=yellow>"..(VET_4_SOUL_MAX_PLANT_TIMES-GetTask(VET_201012_04_PLANT_4_SOUL_TREE_COUNT)).."<color> c©y T?Linh.",0);		        
    		--------------   
    	...
    	if nDate >= 130214 and nDate <= 130228 then	
			...
			--gf_AddItemEx2({2,1,30030, 60}, "TiÓu Nh?Y1", "NIEN THU NHU Y", "hoµn thµnh 16 c©y T?Linh")
		end	
