...
function main()
	...
	if (VET_201103_EventBoss_CheckSmallAward() == 1) then
		if gf_Judge_Room_Weight(1, 0, "") == 1 then
			...
			gf_AddItemEx2({2,1,30091, 1},VET_TB_201103_EVENTBOSS_ITEM_TITLE[5],VET_STR_201103_EVENTBOSS_LOG_TITLE,format(VET_TB_201103_EVENTBOSS_LOG_ACTION_LIST[1],VET_TB_201103_EVENTBOSS_NPC_NAME[2]),0,1);
		end
	end
end