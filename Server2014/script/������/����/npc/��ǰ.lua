...
function main()
	...
	--Ò»°ãÇé¿öÏÂµÄ¶Ô»°
	strTalk = {
		{"Vâ c«ng cña ta trong ph¸i kh«ng nhÊt còng nh× nh­ng tr­ëng m«n s­ huynh l¹i kh«ng chÞu nh­êng chøc tr­ëng m«n, thËt lµ tøc."},
		{"NÕu ta ®­îc lµm tr­ëng m«n nhÊt ®Þnh C«n L«n sÏ thµnh vâ l©m ®Ö nhÊt ®¹i ph¸i."},
		}
	...
	elseif n_task_step == 1 then
		Talk(6,"",
			...
			PLAYER_NAME.."§­îc, ta sÏ ®i chuÈn bÞ."
		)
	...
	elseif n_task_step == 2 and GetItemCount(2,0,779) == 1 then
		Talk(5,"",
			...
			TaskTip("Tíi hËu s¬n Thiªn Nguyªn Th¸p dïng Thiªn S­ Phï kÝch ho¹t Thiªn Nguyªn Ph¸p TrËn phong Ên Hå Yªu")
			Msg2Player("Tíi hËu s¬n Thiªn Nguyªn Th¸p (197/194) dïng Thiªn S­ Phï kÝch ho¹t Thiªn Nguyªn Ph¸p TrËn phong Ên Hå Yªu")
			SetTask(TB_FACTION_TASKID_LIST[KUN_FACTION_ID],3)
			return
	elseif n_task_step == 4 then
		Talk(2,"",
			NPC_NAME.."ThiÕu hiÖp hoµn thµnh nhiÖm vô xuÊt s¾c, l·o phu rÊt hµi lßng, C«n L«n Ph¸i chµo mõng thiÕu hiÖp gia nhËp, ta ®· ®¨ng ký danh s¸ch, cã thÓ ®i t×m Ch­ëng M«n (199/200).",
